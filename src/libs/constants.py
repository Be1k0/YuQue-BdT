...
class GlobalConfig:
    ...
    github_repo_url: str = "https://github.com/Be1k0/YuQue-BdT"  # 项目仓库地址
    github_latest_release_api: str = "https://api.github.com/repos/Be1k0/YuQue-BdT/releases/latest"  # 最新版本接口
